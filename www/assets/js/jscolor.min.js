    ...
    var e = {
        ...
        jscolor: function(t, n) {
            ...
            this.hide = function() {
                ...
                t & e.leaveStyle || this.styleElement && (this.styleElement.style.backgroundImage = "none", this.styleElement.style.color = "#" + this.toString()), !(t & e.leavePad) && l() && a(), !(t & e.leaveSld) && l() && f()
